...
//fonts
#define MINICAL_FONT_NAME						_T("Tahoma")
...
void CMiniCalendarCtrl::Initialize(CCalendarWnd* _pWnd,
...
void CMiniCalendarCtrl::SetCellPosition(int _iMonthRow,
										const CRect& _rect)
{
	int iRow = _iMonthRow-1;
...
void CMiniCalendarCtrl::SetHotSpot(int _iMonthRow,
								   int _iDayCounter,
								   const COleDateTime& _date,
								   const CRect& _rect)
{
	int iRow = _iMonthRow-1;
	...
	if ((iRow >= 0) && (iRow < m_iRows) &&
		(_iDayCounter >= 0) && (_iDayCounter < MINICAL_NUM_CELLS))
	{
...
int CMiniCalendarCtrl::DrawDaysOfWeek(CDC& _dc,
									  int _iY,
									  int _iLeftX,
									  int _iRow)
{
