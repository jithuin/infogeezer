...
# ADD CPP /nologo /MTd /W4 /Gm /GX /ZI /Od /D "_DEBUG" /D "_UNICODE" /D "UNICODE" /D "_USRDLL" /D "MYSPELLCHECK_EXPORTS" /D "_EXPORTING" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /FR /FD /GZ /c
...
# ADD CPP /nologo /MT /W4 /GX /O2 /D "_USRDLL" /D "MYSPELLCHECK_EXPORTS" /D "_EXPORTING" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_UNICODE" /D "UNICODE" /FD /c
# SUBTRACT CPP /Fr
