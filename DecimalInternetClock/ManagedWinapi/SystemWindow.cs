...
namespace ManagedWinapi.Windows
{
	...
	public class SystemWindow
	{
		...
		/// <summary>
		/// Allows getting the current active window and setting it.
		/// </summary>
		public static SystemWindow ActiveWindow
		{
			get
			{
				return new SystemWindow(GetActiveWindow());
			}
			set
			{
				SetActiveWindow(value.HWnd);
			}
		}
