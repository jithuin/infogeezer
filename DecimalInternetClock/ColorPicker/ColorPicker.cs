...
namespace ColorPicker
{
    ...
    public class ColorPickerControl : Control
    {
        ...
        static ColorPickerControl()
        {
            ...
            EventManager.RegisterClassHandler(typeof(ColorPickerControl), Slider.ValueChangedEvent, new RoutedPropertyChangedEventHandler<double>(ColorPickerControl.OnSliderValueChanged));

            // Register Event Handler for Hsv Control
            EventManager.RegisterClassHandler(typeof(ColorPickerControl), HsvControl.SelectedColorChangedEvent, new RoutedPropertyChangedEventHandler<Color>(ColorPickerControl.OnHsvControlSelectedColorChanged));
        }
        ...
        {
            ColorPickerControl colorPicker = sender as ColorPickerControl;
        ...
        {
            ColorPickerControl colorPicker = relatedObject as ColorPickerControl;
