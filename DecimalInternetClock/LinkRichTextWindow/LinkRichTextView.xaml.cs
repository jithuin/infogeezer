...
namespace LinkRichTextWindow
{
    ...
    /// </summary>
    public partial class LinkRichTextView : Window
    {
        public LinkRichTextView()
        {
            InitializeComponent();
        ...
        private RelayCommand _exitCommand = new RelayCommand(new Action(() => Application.Current.Shutdown()));
        ...
        public static readonly DependencyProperty RichTextProperty =
            DependencyProperty.Register("RichText", typeof(FlowDocument), typeof(LinkRichTextView), new UIPropertyMetadata(null));

        private List<String> _listOfFormats = new List<string>()
            {
                DataFormats.Html,
                DataFormats.OemText,
                DataFormats.Rtf,
